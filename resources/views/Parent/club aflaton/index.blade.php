...
@endguest
  ...
  <center>
  <img src="club-aflatoun-pour-les-enfants-1.jpg" alt=" " class="img-fluid"  width="1000px" height="1000px">
  </center>
  <br>
  <br>
  <div class="pro-description">
            ...
            <li role="presentation" class="active"><a href="#sescription" aria-controls="sescription" role="tab"
                  data-bs-toggle="tab" data-bs-target="#sescription">نوادي أفلاطون لتعريف الأطفال بثقافة ريادة الأعمال والمواطنة</a></li>
    ...
    <div class="overlay padding-100">
      <div class="section-header bg">
        ...
        <p style="font-size:25px;">برنامج  » افلاطون » للتربية والتعليم الاجتماعي والمالي للأطفال يعتمد بالأساس على ادراج التربية الاجتماعية والمالية صلب المنهج التعليمي من خلال النوادي المحدثة في المؤسسات التربوية، ومن ابرز عناصره استكشاف وفهم الذات بالنسبة للأطفال وتعويده على الحقوق والمسؤوليات وأيضا تطوير فكرة ومبدا الادخار والانفاق الرشيد والمسؤول وحسن التخطيط ووضع الميزانيات الى جانب ترسيخ فكرة الطفل المستثمر او الباعث من خلال أفكار مشاريع اجتماعية ومالية .</p>
      </div>
      </div><!-- overlay -->
  </section><!-- gallery -->
              <br>
...
<input type="text" name="s1" placeholder=" هل سمعت عن هذا البرنامج سابقا "  class="contact-input"  required autocomplete="s1" autofocus>
              <input type="hidden"  placeholder=" هل سمعت عن هذا البرنامج سابقا "   class="contact-input" required>
              <input type="text" name="s2" placeholder="هل ترى أية موهبة عند طفلك "    class="contact-input" required>
              <input type="text" name="s3" placeholder="ما الذي تنتظره من هذا البرنامج "   class="contact-input" required>
              <input type="text" name="s4" placeholder="هل لدى طفلك مشاكل نفسية"  class="contact-input">
              <input type="text" name="s5" placeholder="هل قام طفلك بتجربة ادخار المال سابقا ؟"  class="contact-input" required>
