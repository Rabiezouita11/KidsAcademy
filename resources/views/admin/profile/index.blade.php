...
<body class="theme-red">
    ...
    <section class="content">
                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            <div class="image-area">
                                <img src="{{ Auth::user()->image }}"  width="150px" height="150px"alt="AdminBSB - Profile Image" />
                            </div>
                            <div class="content-area">
                                <h3> {{ Auth::user()->name }}</h3>
                             
                                <p>أستاذة تربية و تعليم</p>
                            </div>
                        </div>
                        ...
                        <div class="body">
                            <div>
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"  class="active"><a href="#profile_settings" aria-controls="settings" role="tab" data-toggle="tab">إعدادات الملف الشخصي</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <form class="form-horizontal"  action="{{route('x')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in" id="change_password_settings">
                                        <form class="form-horizontal" action="{{route('a')}}" method="post">
                                            <div class="form-group" >
                                                <label for="OldPassword" class="col-sm-3 control-label">كلمة سر قديمة</label>
                                                <div class="col-sm-9">
                                                    <div class="form-line">
                                                        <input type="password" class="form-control" id="OldPassword"  name="old_password" placeholder="كلمة سر قديمة" required>
		...
		@endif
                                            ...
                                            <div class="form-group">
                                                <label for="NewPassword" class="col-sm-3 control-label">كلمة السر الجديدة</label>
                                                <div class="col-sm-9">
                                                    <div class="form-line">
                                                        <input type="password" class="form-control" id="NewPassword" name="new_password" placeholder="كلمة السر الجديدة" required>
		...
		@endif
                                            ...
                                            <div class="form-group">
                                                <label for="NewPasswordConfirm" class="col-sm-3 control-label">كلمة مرور جديدة (تأكيد)</label>
                                                <div class="col-sm-9">
                                                    <div class="form-line">
                                                        <input type="password" class="form-control" id="NewPasswordConfirm"  name="confirm_password" placeholder="كلمة مرور جديدة (تأكيد)" required>
