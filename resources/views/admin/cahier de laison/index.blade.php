...
?>
  ...
  <a class="btn btn-primary" href="{{route('pageRepondre')}}" role="button">ajouter message </a></center>
@else
...
$a=$l->etat;
           ...
           ?>
              ...
              @else 
              <td>  <a class="btn btn-success" href="{{ route('AfficheEditmessage', ['id' => $l->id]) }}"  role="button">repondre</a></td>
              @endif
              </tr>
             @endforeach
